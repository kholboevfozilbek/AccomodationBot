...
def process_type_apartment_step(message):
    ...
    ### We need mechanism to give the customer option to select if he wants to get results for the parameters he has given
    ### such as types, size, price ... I imagine smth like this. There is x amount of apartments available for your input
    ### would you like to see them or proceed with giving more parameters and narrowing down the number of apartments
    ### for that we need to make sql query and get the entries of out db and have the options to show
    ...
    if query:
        ...
        if results:
            ...
            bot.register_next_step_handler(msg, process_display_results_step, results, "process_price_step")
        else:
        ...
        msg = bot.reply_to(message, "Please provide some search parameters to continue.")
        bot.register_next_step_handler(msg, process_price_step)

def process_display_results_step(message, results, next_step_name):
